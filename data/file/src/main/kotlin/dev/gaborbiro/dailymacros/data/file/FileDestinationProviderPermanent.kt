...
internal class FileDestinationProviderPermanent(
     ...
     * /data/data/dev.gaborbiro.dailymacros/files/[folder]/[filePath]
     *
     ...
     * advisable to implement a cleanup strategy. See [dev.gaborbiro.dailymacros.data.file.domain.FileStore.delete].
     *

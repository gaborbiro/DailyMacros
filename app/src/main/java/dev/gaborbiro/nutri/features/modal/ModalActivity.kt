package dev.gaborbiro.nutri.features.modal
...
import dev.gaborbiro.nutri.features.common.BaseErrorDialogActivity
import dev.gaborbiro.nutri.features.common.ErrorViewModel
import dev.gaborbiro.nutri.features.common.RecordsMapper
import dev.gaborbiro.nutri.features.modal.model.DialogState
import dev.gaborbiro.nutri.features.modal.model.HostViewState
import dev.gaborbiro.nutri.features.modal.model.ImagePickerState
import dev.gaborbiro.nutri.features.modal.usecase.CreateRecordUseCase
import dev.gaborbiro.nutri.features.modal.usecase.EditRecordImageUseCase
import dev.gaborbiro.nutri.features.modal.usecase.EditRecordUseCase
import dev.gaborbiro.nutri.features.modal.usecase.EditTemplateImageUseCase
import dev.gaborbiro.nutri.features.modal.usecase.EditTemplateUseCase
import dev.gaborbiro.nutri.features.modal.usecase.FoodPicSummaryUseCase
import dev.gaborbiro.nutri.features.modal.usecase.GetRecordImageUseCase
import dev.gaborbiro.nutri.features.modal.usecase.SaveImageUseCase
import dev.gaborbiro.nutri.features.modal.usecase.ValidateCreateRecordUseCase
import dev.gaborbiro.nutri.features.modal.usecase.ValidateEditImageUseCase
import dev.gaborbiro.nutri.features.modal.usecase.ValidateEditRecordUseCase
import dev.gaborbiro.nutri.features.modal.views.EditImageTargetConfirmationDialog
import dev.gaborbiro.nutri.features.modal.views.EditTargetConfirmationDialog
import dev.gaborbiro.nutri.features.modal.views.ImageDialog
import dev.gaborbiro.nutri.features.modal.views.InputDialog
...
//        }
    ...
    private val viewModel by lazy {
        ...
        ModalScreenViewModel(
            ...
            foodPicSummaryUseCase = FoodPicSummaryUseCase(bitmapStore, chatGPTRepository, mapper = RecordsMapper())
        )
    }

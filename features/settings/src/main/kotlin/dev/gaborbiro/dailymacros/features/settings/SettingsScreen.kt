...
fun SettingsScreen(
    ...
    SettingsView(
        ...
        onTimezoneAdaptationTapped = settingsViewModel::onTimezoneAdaptationRowTapped,
        onTimezoneAdaptationDialogDismissed = settingsViewModel::onTimezoneAdaptationDialogDismissed,
        onTimezoneAdaptationHoursSelected = settingsViewModel::onTimezoneAdaptationHoursSelected,

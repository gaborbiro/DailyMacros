...
import dev.gaborbiro.dailymacros.features.shared.notifications.TitleTextNotificationSender
import dev.gaborbiro.dailymacros.repositories.settings.prefs.SettingsPrefs
...
class MineMealVariabilityWorker @AssistedInject constructor(
    ...
    private val titleTextNotificationSender: TitleTextNotificationSender,
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            titleTextNotificationSender.showTitleTextNotification(
